...
class SwapTest:
    def __init__(self,prepare_input_states=False,input_state_dim=None,nq=0,measure=False,copies=1000):
        self.nq = nq
...
#                 print(self.input_1)
        ...
        for i in range(len(self.input_1)):
            self.circuit.append(cirq.CSWAP(self.ancilla_qubit, self.input_1[i], self.input_2[i]))
